      ...
      <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
          ...
          {emailsToInvite.map(email => {
            return (
              <div key={email} className='py-1.5 px-2.5 rounded-md bg-zinc-800 flex items-center gap-2'>
                ...
                <button type='button' onClick={() => removeEmailsFromInvite(email)}>
        ...
        <form onSubmit={addNewEmailToInvite} className='p-2.5 bg-zinc-950 border-zinc-800 rounded-lg flex items-center gap-2'>
          <div className='px-2 flex items-center gap-2 flex-1'>
            ...
            <input type="email" name='email' placeholder="Digite o e-mail do convidado" className="bg-transparent text-lg placeholder-zinc-400 outline-none flex-11 " />
          </div>
